  ...
  <Layout>
    ...
    <section className="services">
      <div className="privacy">
        ...
        <p>
          name: Clemens R. Fabig
          <br />
          email: crfabig@gmail.com
          <br />
          phone: <br />
          adress: Marigondon Beach Road, Lapu-Lapu City, Philippines
          <br />
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to Freelance Web and
          ...
          <li>
            <strong>Website</strong> refers to Freelance Web and Mobile
            Application Development, accessible from www.clemensfabig.com
          </li>{" "}
          <li>
        ...
        <ul>
          <li>By email: crfabig@gmail.com</li>
        </ul>
        <br />
        <br />
        <br />
