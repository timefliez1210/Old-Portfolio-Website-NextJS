...
const ContactSection = () => {
  ...
  return (
    <Contact id="contact">
      ...
      <br />
      <h3>
        Nevertheless please consider writing me first, either directly or on
        those platforms, so we can make sure that I can perfectly fit your needs
        and prenegotiate the gig I will make there for you.
        <br />
        <br />
